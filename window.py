...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('鸟类识别系统')  # todo 系统名称
        # 模型初始化
        self.model = tf.keras.models.load_model("models/mobilenet_birds.h5")  # todo 模型名称
        self.to_predict_name = "images/1.jpg"  # todo 初始图片
        self.class_names = ['八哥', '喜鹊', '孔雀', '海鸥', '画眉', '鸽子', '鹌鹑', '鹦鹉', '鹰隼', '麻雀']  # todo 类名，这个数组在模型训练的开始会输出
        self.resize(900, 700)
        self.initUI()
    ...
    def initUI(self):
        ...
        about_title = QLabel('欢迎使用鸟类识别系统')  # todo 欢迎词语
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/2.jpg'))
        about_img.setAlignment(Qt.AlignCenter)
        label_super = QLabel("作者：黄梓彦")  # todo 作者信息
    ...
    def predict_img(self):
        ...
        result = self.class_names[result_index]  # 获得对应的鸟类名称
        self.result.setText(result)  # 在界面上显示
